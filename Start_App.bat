...
set "SERENITY_FER_CV2_THREADS=1"
set "SERENITY_FER_MAX_FRAME_SIDE=640"
set "SERENITY_FER_FACE_MIN_SIZE=48"
...
set "SERENITY_CLOUD_LLM_POOL_CONNECTIONS=2"
set "SERENITY_CLOUD_LLM_POOL_MAXSIZE=4"
set "SERENITY_ADMIN_DEFAULT_LIMIT=200"
set "SERENITY_ADMIN_CHAT_TEXT_LIMIT=360"
set "SERENITY_ADMIN_SESSION_TEXT_LIMIT=360"
